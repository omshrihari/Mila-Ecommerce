...
class ThirdBannerController extends Controller
{
     ...
     */
    public $page_title = 'Third Level Banner';

    public function index()
    {
        $page_title = $this->page_title;
        $banner = ThirdLevelBanner::first();
        return view('admin.management.third_level_banner', compact('page_title', 'banner'));
    }
    ...
    {
        $banner = ThirdLevelBanner::find($id);
        $update = $request->all();
        ...
        return redirect()->route('admin.thirdlevelbanner.index')->with('success', 'banner updated successfully');
    }

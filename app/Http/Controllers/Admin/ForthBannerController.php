...
class ForthBannerController extends Controller
{
    /**
     * Display a listing of the resource.
     */
    public $page_title = 'Forth Banner';

    public function index()
    {
        $page_title = $this->page_title;
        $banner = ForthLevelBanner::first();
        return view('admin.management.forth_level_banner', compact('page_title', 'banner'));
    }
    ...
    {
        $banner = ForthLevelBanner::find($id);
        $update = $request->all();
        ...
        return redirect()->route('admin.forthlevelbanner.index')->with('success', 'banner updated successfully');
    }

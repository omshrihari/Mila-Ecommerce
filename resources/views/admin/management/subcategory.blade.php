                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            ...
                            <div>
                                <button onclick="window.location.href='{{ route('admin.subcategory.create') }}'" id="addRow" class="btn btn-primary">Add New {{ $page_title }}</button>
                            </div>
                        </div>
                        <div class="card-body">
                            @livewire('subcategory_table')
                        </div>
                    </div>
                </div><!--end col-->
            </div><!--end row-->

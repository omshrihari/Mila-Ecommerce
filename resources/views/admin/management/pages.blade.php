                            ...
                            <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $loop->index+1 }}</td>
                                        <td>{{ $page->title }}</td>
                                        <td>{{ strip_tags(substr($page->description,0,100)) }}</td>
                                        <td>
                                            <a href="{{ route('admin.page.edit', $page->id) }}" class="dropdown-item edit-item-btn"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>

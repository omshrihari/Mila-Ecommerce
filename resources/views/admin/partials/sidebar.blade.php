        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="index.html" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="{{ asset('web/assets/img/logo/logo-milachin.png') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('web/assets/img/logo/logo-milachin.png') }}" alt="" height="50">
                    </span>
                </a>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#homepageManage" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="homepageManage">
                                <i class="ri-home-2-line"></i> <span data-key="t-dashboards">Homepage</span>
                            </a>
                        </li>
                        <div class="collapse menu-dropdown" id="homepageManage">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="#bannersMenu" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="bannersMenu" data-key="t-calender">
                                        Banner Management
                                    </a>
                                    <div class="collapse menu-dropdown" id="bannersMenu">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{ route('admin.mainbanner.index') }}" class="nav-link" role="button">
                                                    Main Banner
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ route('admin.secondlevelbanner.index') }}" class="nav-link" role="button">
                                                    2nd Level Banner
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ route('admin.thirdlevelbanner.index') }}" class="nav-link" role="button">
                                                    3rd Level Banner
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ route('admin.forthlevelbanner.index') }}" class="nav-link" role="button">
                                                    4th Level Banner
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ route('admin.fivelevelbanner.index') }}" class="nav-link" role="button">
                                                    5th Level Banner
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ route('admin.sixlevelbanner.index') }}" class="nav-link" role="button">
                                                    6th Level Banner
                                                </a>
                                            </li>
                                        </ul>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.yt.index') }}" class="nav-link" role="button">
                                        YT Video Management
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#productManage" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="productManage">
                                <i class="ri-home-2-line"></i> <span data-key="t-dashboards">Product Management</span>
                            </a>
                        </li>
                        <div class="collapse menu-dropdown" id="productManage">
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.subcategory.index') }}" class="nav-link" role="button">
                                        SubCategory Manage
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.subsubcategory.index') }}" class="nav-link" role="button">
                                        Sub SubCategory Manage
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('admin.product.index') }}" class="nav-link" role="button">
                                        Product Management
                                    </a>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.page.index') }}">
                                <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Pages Management</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{ route('admin.order.index') }}">
                                <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Order Management</span>
                            </a>
                        </li>
                        <li class="nav-item">

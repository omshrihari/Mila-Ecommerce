                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <select name="category_id" class="form-control">
                                            @foreach ($categories as $cat)
                                                <option @selected($subcategory->category_id == $cat->id) value="{{ $cat->id }}">{{ $cat->title }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <br>
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="title"
                                            id="manufacturer-name-input" placeholder="Enter Subcategory Name" value="{{ $subcategory->title }}">
                                    </div>
                                    <br>
                                    <div>
                                        <label class="form-label" for="manufacturer-name-input">Image</label>
                                        <input type="file" class="form-control" name="image"><br>
                                        <img src="{{ asset('web/uploads/'.$subcategory->image) }}" alt="" width="10%">
                                    </div>
                                </div>
                            </div>
                            <!-- end card -->
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="sort"
                                                            id="manufacturer-name-input" placeholder="Enter Sorting number" value="{{ $subcategory->sort }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="status" class="form-control">
                                                            <option @selected($subcategory->status == '1') value="1">Activate</option>
                                                            <option @selected($subcategory->status == '0') value="0">Deactivate</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tab-pane" id="addproduct-metadata" role="tabpanel">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="meta_title" class="form-control" placeholder="Enter meta title" value="{{ $subcategory->meta_title }}" id="meta-title-input">
                                                    </div>
                                                </div>
                                                <!-- end col -->
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="meta_key" class="form-control" placeholder="Enter meta keywords" value="{{ $subcategory->meta_key }}" id="meta-keywords-input">
                                                    </div>
                                                </div>
                                                <!-- end col -->
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <textarea class="form-control" name="meta_des" id="meta-description-input" placeholder="Enter meta description" rows="3">{{ $subcategory->meta_des }}</textarea>
                                            </div>
                                        </div>
                                        <!-- end tab pane -->
                                    </div>

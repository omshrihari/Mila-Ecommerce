                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <input type="text" class="form-control" name="title"
                                            id="manufacturer-name-input" placeholder="Enter Category Name" value="{{ $category->title }}">
                                    </div>
                                </div>
                            </div>
                            <!-- end card -->
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name="sort"
                                                            id="manufacturer-name-input" placeholder="Enter Sorting number" value="{{ $category->sort }}">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="status" class="form-control">
                                                            <option @selected($category->status == '1') value="1">Activate</option>
                                                            <option @selected($category->status == '0') value="0">Deactivate</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>

(function ($) {
    ...
    $('.categories_column6').on('changed.owl.carousel initialized.owl.carousel', function (event) {
        ...
        autoplay: false,
        autoplayTimeout: 8000,
        items: 6,  // Change this to 6
        margin: 20,
        dots: false,
        navText: ['<i class="ion-ios-arrow-back owlnbtn"></i>','<i class="ion-ios-arrow-forward owlnbtn"></i>'],
        responsiveClass: true,
        responsive: {
            0: {
                items: 2,
